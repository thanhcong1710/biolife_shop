...
<body>
    ...
    <script src="admin_asset/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" language="javascript" src="admin_asset/ckfinder/ckfinder.js" ></script>
